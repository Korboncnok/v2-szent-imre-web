        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">Az idei csapattáborunkat 2025. július 4-én kezdjük. Minden információt megtalálhatnak a meghívóban.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="embed-responsive embed-responsive-16by9">
                  <iframe class="embed-responsive-item w-100" src="https://drive.google.com/file/d/17_Zsx4OUeQ2uFX2ZINkM4BeU-NeNINcT/preview" style="aspect-ratio: 16/9; border: none;" allowfullscreen></iframe>
                </div>
              </div>
            </div>
          </div>
